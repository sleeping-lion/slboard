...
Group.create(:title=>'admins')
Group.create(:title=>'managers')
Group.create(:title=>'users')
Group.create(:title=>'viewers')

User.create(:id=>1,:group_id=>1,:email => 'toughjjh@gmail.com',:name=>'정종호',:nickname=>'잠자는-사자',:password => 'jjh123456', :password_confirmation => 'jjh123456',:photo=>File.open(Rails.root.join("app", "assets", "images", "intro", "sl.jpg")),:admin=>true)
